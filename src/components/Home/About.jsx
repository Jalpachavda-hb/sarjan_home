          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-6 p-2 ml-4 p-md-5"> 
              ...
              <p className="para mb-4">
                ...
                dream home becomes a reality. With access to the most desirable
                properties and up-to-date market insights, we take pride in
                offering personalized support tailored to your needs. Whether
                you're a first-time buyer or an experienced investor, we’re here
                to make your home buying experience smooth, transparent, and
                rewarding.
              </p>
